...
const renderManager = manager => {
  ...
  template = replacePlaceholders(template, "id", manager.promptIdentifier());
...
const renderEngineer = engineer => {
  ...
  template = replacePlaceholders(template, "id", engineer.promptIdentifier());
...
const renderIntern = intern => {
  ...
  template = replacePlaceholders(template, "id", intern.promptIdentifier());
